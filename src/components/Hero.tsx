      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-2">
          ...
          <FloatingElement speed={0.4}>
            <div className="absolute top-40 right-20 w-24 h-24 bg-purple-500/5 rounded-full blur-xl" />
          </FloatingElement>
          <FloatingElement speed={0.2}>
            <div className="absolute bottom-32 left-20 w-40 h-40 bg-cyan-500/5 rounded-full blur-xl" />
          </FloatingElement>
          <FloatingElement speed={0.5}>
            <div className="absolute bottom-20 right-10 w-28 h-28 bg-pink-500/5 rounded-full blur-xl" />
          </FloatingElement>
        </div>
