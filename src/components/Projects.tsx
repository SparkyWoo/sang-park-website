...
import { TiltCard, HoverTilt } from './Advanced3D';
import { RevealSection, ParallaxSection } from './StorytellingSection';
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {projects.map((project, index) => (
              <RevealSection key={project.title} direction="up" delay={index * 0.1}>
...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    <TiltCard intensity={0.8} className="h-full">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.technologies.map((tech, techIndex) => (
                  <HoverTilt key={tech} intensity={0.3}>
                    <PhysicsAnimations 
                      type="elastic" 
                      intensity={0.3}
                    >
