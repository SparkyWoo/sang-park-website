...
const Contact = () => {
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/sangpark',
      icon: (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/sangpark',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/sangpark',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                className="flex items-center justify-center w-12 h-12 rounded-full border border-gray-700 text-gray-400 hover:text-white hover:border-gray-600 transition-all duration-300"
